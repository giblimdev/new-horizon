...
type Props = {
  initialData?: Partial<NeighborhoodFormValues>;
  onSubmit: (data: NeighborhoodFormValues) => void;
  onCancel: () => void;
  cityOptions: { id: string; name: string }[]; // Liste des villes pour le select
};

export default function ItemFormNeighborhood({
  initialData = {},
  onSubmit,
  onCancel,
  cityOptions,
  ...
  return (
    <form
      ...
      aria-label="Formulaire quartier"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <input
            id="name"
            {...register("name", {
              required: "Le nom du quartier est requis",
            ...
            autoFocus
            placeholder="Ex : Montmartre, Soho, Chelsea…"
          />
          {errors.name && (
